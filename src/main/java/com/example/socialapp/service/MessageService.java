...
public class MessageService {
    ...
    public void sendGroupMessage(String groupDiscussionId, String senderId, String content) {
        ...
        messageRepository.save(message);
        log.info("Group message sent | id={} | sender={} | group={} | sentAt={}",
                message.getId(), senderId, groupDiscussionId, message.getSentAt());
    ...
    public Message sendFile(String discussionId, String senderId, MultipartFile file) {
        ...
        try {
            ...
            messageRepository.save(message);
            log.info("File sent | id={} | sender={} | discussion={} | file={} | sentAt={}",
                    id, senderId, discussionId, fileName, message.getSentAt());
